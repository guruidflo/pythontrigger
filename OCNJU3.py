...
json_file_name = 'fileNJU3-'+date_str+'.json'
xlsx_file_name =  'fileNJU3-'+date_str+'.xlsx'
...
url = "http://api.fabtrakr.com/analytics/sewing/dateWise/efficiency/location/NJU3"
parameters = {
