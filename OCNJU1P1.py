...
json_file_name = 'fileNJU1P1-'+date_str+'.json'
xlsx_file_name =  'fileNJU1P1-'+date_str+'.xlsx'
...
url = "http://api.fabtrakr.com/analytics/sewing/dateWise/efficiency/location/NJU1P1"
parameters = {
