...
json_file_name = 'fileIDU6-'+date_str+'.json'
xlsx_file_name =  'fileIDU6-'+date_str+'.xlsx'
...
url = "http://api.fabtrakr.com/analytics/sewing/dateWise/efficiency/location/IDU6"
parameters = {
