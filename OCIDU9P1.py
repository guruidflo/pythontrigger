...
json_file_name = 'fileIDU9P1-'+date_str+'.json'
xlsx_file_name =  'fileIDU9P1-'+date_str+'.xlsx'
...
url = "http://api.fabtrakr.com/analytics/sewing/dateWise/efficiency/location/IDU9P1"
parameters = {
