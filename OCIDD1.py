...
json_file_name = 'fileIDD1-'+date_str+'.json'
xlsx_file_name =  'fileIDD1-'+date_str+'.xlsx'
...
url = "http://api.fabtrakr.com/analytics/sewing/dateWise/efficiency/location/IDD1"
parameters = {
