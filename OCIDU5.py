...
json_file_name = 'fileIDU5-'+date_str+'.json'
xlsx_file_name =  'fileIDU5-'+date_str+'.xlsx'
...
url = "http://api.fabtrakr.com/analytics/sewing/dateWise/efficiency/location/IDU5"
parameters = {
