...
json_file_name = 'fileNJU2-'+date_str+'.json'
xlsx_file_name =  'fileNJU2-'+date_str+'.xlsx'
...
url = "http://api.fabtrakr.com/analytics/sewing/dateWise/efficiency/location/NJU2"
parameters = {
